...
<body id="top">
  ...
  <div class="wrapper bgded overlay" style="background-image:url('https://image.freepik.com/free-photo/light-bulb-ideas-creative-diagram-concept_53876-92925.jpg');">
    <div id="pageintro" class="hoc clear">
      <!-- ################################################################################################ -->
      <article>
        <h3 class="heading">Study Planner</h3>
        <p> If you fail to plan, your are planning to fail.
          <br> - Benjamin Franklin
        </p>
        <footer>
          <ul class="nospace inline pushright">
            <li><a class="btn" href="#calendar"> Plan </a></li>
          </ul>
        </footer>
      </article>
      <!-- ################################################################################################ -->
...
<div class="main" id="calendar">
  <iframe
    src="https://pub3.bravenet.com/calendar/show.php?usernum=202362364&embedded=true"
    style="margin:0;border:0;padding:0;height:600px;width:100%;">
</iframe>
</div>
  </body>
  <html>